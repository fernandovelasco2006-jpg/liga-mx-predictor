...
HORARIOS_PARTIDO = {
    ...
    ('Tigres', 'Atletico San Luis'): '2026-07-25 21:00',
    ('Tijuana', 'Leon'): '2026-07-24 20:00',
    ('Atlante', 'America'): '2026-07-24 21:00',
    ('Guadalajara', 'FC Juarez'): '2026-07-25 17:07',
    ('Santos Laguna', 'Atlas'): '2026-07-25 21:00',
    ('Necaxa', 'Monterrey'): '2026-07-26 17:00',
    ('Pachuca', 'Queretaro'): '2026-07-26 19:06',
    ...
    ('Tigres', 'Necaxa'): '2026-09-05 19:00',
    ('America', 'Tijuana'): '2026-10-28 21:00',
    ('Atlas', 'Atlante'): '2026-09-05 21:00',
    ('Pumas UNAM', 'Leon'): '2026-09-10 21:05',
    ...
    ('Santos Laguna', 'FC Juarez'): '2026-09-13 19:00',
    ('Guadalajara', 'Pumas UNAM'): '2026-09-13 19:07',
    ('Monterrey', 'Tigres'): '2026-09-12 19:10',
    ('Puebla', 'Atlante'): '2026-09-18 19:00',
    ('FC Juarez', 'Tigres'): '2026-09-18 21:00',
    ('Atletico San Luis', 'Necaxa'): '2026-09-19 17:00',
    ('Atlas', 'Pumas UNAM'): '2026-09-19 17:00',
    ('Monterrey', 'Cruz Azul'): '2026-09-19 19:00',
    ('America', 'Guadalajara'): '2026-09-19 21:00',
    ('Toluca', 'Santos Laguna'): '2026-09-20 18:00',
    ('Pachuca', 'Tijuana'): '2026-09-20 18:00',
    ('Queretaro', 'Leon'): '2026-09-20 20:05',
    ('Atlante', 'Monterrey'): '2026-09-25 19:00',
    ('Tijuana', 'Atlas'): '2026-09-25 21:00',
    ('Guadalajara', 'Queretaro'): '2026-09-26 17:07',
    ('Santos Laguna', 'Pachuca'): '2026-09-26 19:00',
    ('Tigres', 'Puebla'): '2026-09-26 19:00',
    ('Cruz Azul', 'Toluca'): '2026-09-26 17:00',
    ('Pumas UNAM', 'Atletico San Luis'): '2026-09-27 12:00',
    ('Leon', 'FC Juarez'): '2026-09-27 19:00',
    ('Necaxa', 'America'): '2026-09-27 21:00',
    ('Queretaro', 'Atlante'): '2026-10-09 19:00',
    ...
    ('America', 'Monterrey'): '2026-10-10 21:00',
    ('Pachuca', 'Necaxa'): '2026-10-11 17:00',
    ('Atletico San Luis', 'Santos Laguna'): '2026-10-11 17:00',
    ('Pumas UNAM', 'Cruz Azul'): '2026-10-11 19:00',
    ('Necaxa', 'Atlas'): '2026-10-16 19:00',
    ('Tijuana', 'Puebla'): '2026-10-16 21:00',
    ('Atlante', 'Pumas UNAM'): '2026-10-16 21:00',
    ('Guadalajara', 'Tigres'): '2026-10-17 17:07',
    ('Santos Laguna', 'Queretaro'): '2026-10-17 17:00',
    ('Leon', 'America'): '2026-10-17 19:00',
    ('Toluca', 'Atletico San Luis'): '2026-10-17 19:00',
    ('Cruz Azul', 'FC Juarez'): '2026-10-17 21:00',
    ('Monterrey', 'Pachuca'): '2026-10-18 19:00',
    ('FC Juarez', 'Atlante'): '2026-10-20 19:00',
    ('Atletico San Luis', 'Queretaro'): '2026-10-20 19:00',
    ('Tigres', 'Leon'): '2026-10-20 21:00',
    ('Guadalajara', 'Necaxa'): '2026-10-20 21:07',
    ('Puebla', 'Monterrey'): '2026-10-21 19:00',
    ('Atlas', 'America'): '2026-10-21 19:00',
    ('Toluca', 'Tijuana'): '2026-10-21 19:00',
    ('Pachuca', 'Cruz Azul'): '2026-10-21 21:00',
    ('Santos Laguna', 'Pumas UNAM'): '2026-10-21 21:00',
    ('Necaxa', 'FC Juarez'): '2026-10-23 19:00',
    ('Atlante', 'Atletico San Luis'): '2026-10-23 21:00',
    ('Leon', 'Toluca'): '2026-10-24 17:00',
    ('Monterrey', 'Guadalajara'): '2026-10-24 19:00',
    ('Pumas UNAM', 'Tigres'): '2026-10-24 21:00',
    ('Atlas', 'Puebla'): '2026-10-25 18:00',
    ('America', 'Pachuca'): '2026-10-25 18:00',
    ('Queretaro', 'Cruz Azul'): '2026-10-25 20:00',
    ('Tijuana', 'Santos Laguna'): '2026-10-25 21:00',
    ('FC Juarez', 'Queretaro'): '2026-10-30 20:00',
    ('Atletico San Luis', 'Atlas'): '2026-10-30 20:00',
    ('Puebla', 'Pumas UNAM'): '2026-10-30 21:00',
    ('Pachuca', 'Tigres'): '2026-10-31 18:00',
    ('Monterrey', 'Tijuana'): '2026-10-31 20:00',
    ('Guadalajara', 'Atlante'): '2026-10-31 20:07',
    ('America', 'Toluca'): '2026-10-31 22:00',
    ('Santos Laguna', 'Necaxa'): '2026-11-01 17:00',
    ('Cruz Azul', 'Leon'): '2026-11-01 19:00',
    ('Necaxa', 'Tijuana'): '2026-11-06 20:00',
    ('Atletico San Luis', 'FC Juarez'): '2026-11-06 20:00',
    ('Atlante', 'Santos Laguna'): '2026-11-06 22:00',
    ('Atlas', 'Pachuca'): '2026-11-07 18:00',
    ('Tigres', 'Cruz Azul'): '2026-11-07 18:00',
    ('Toluca', 'Monterrey'): '2026-11-07 20:00',
    ('Pumas UNAM', 'America'): '2026-11-07 21:00',
    ('Queretaro', 'Puebla'): '2026-11-08 19:00',
    ('Leon', 'Guadalajara'): '2026-11-08 21:00',
    ('Puebla', 'Atletico San Luis'): '2026-11-20 20:00',
    ('FC Juarez', 'Atlas'): '2026-11-20 22:00',
    ('Tijuana', 'Atlante'): '2026-11-20 22:00',
    ('Santos Laguna', 'Leon'): '2026-11-21 18:00',
    ('Pachuca', 'Toluca'): '2026-11-21 17:00',
    ('Pumas UNAM', 'Monterrey'): '2026-11-21 20:00',
    ('Tigres', 'America'): '2026-11-21 22:00',
    ('Guadalajara', 'Cruz Azul'): '2026-11-22 18:07',
    ('Queretaro', 'Necaxa'): '2026-11-22 20:00',
}
